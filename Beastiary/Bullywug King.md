...
traits:
  ...
  - name: Royal Presence
    desc: "Any bullywug that can see or hear the royal at the start of its turn is inspired and has advantage on attack rolls until the start of its next turn."
actions:
  - name: Multiattack
    desc: "The bullywug royal makes two attacks: one with its bite and one with its trident."
  - name: Bite
